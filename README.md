...
The fork exists so that we can iterate faster and add support for QUIC extensions used in [iroh](https://github.com/n0-computer/iroh/). We plan to upstream our changes, if possible.
